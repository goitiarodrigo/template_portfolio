  ...
  return (
    <div id='projects' className={styles.container}>
        ...
        <div className={styles.projects_container}>
            <div style={{backgroundImage: 'url("https://wpocean.com/html/tf/folio-live/folio/assets/images/protfolio/img-1.jpg")'}} className={styles.project_image}>
                <div className={styles.description_container}>
                    <h3>Proyecto</h3>
                    <p>descripcion descripcion descripcion descripcion descripcion descripcion descripcion descripcion descripcion </p>
